...
REDIS_CACHE_TTL_PRODUCT_LIST = 43200  # 12 hours (43200 seconds) - product lists change less frequently
REDIS_CACHE_TTL_HTML = 604800  # 7 days (604800 seconds) - HTML pages stable for 1 week

# Cache validation configuration
CACHE_MIN_FIELDS_FOR_VALIDITY = ["price", "sales_count", "name"]  # Product needs at least one of these
