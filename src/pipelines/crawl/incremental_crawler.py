    ...
    with storage.get_connection() as conn:
        with conn.cursor() as cur:
            ...
            return {
                ...
                'avg_price_change_30d': float(price_stats[2]) if price_stats and price_stats[2] else 0,
            }
...
if __name__ == "__main__":
    ...
    for i, p in enumerate(products, 1):
        last_crawl = p['last_crawled_at'].strftime('%Y-%m-%d %H:%M') if p['last_crawled_at'] else 'Never'
