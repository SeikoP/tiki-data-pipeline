...
# NOTE: tasks module depends on many globals initialized in bootstrap (paths, resilience, imports).
# We intentionally import * to preserve the original behavior without renaming globals.
